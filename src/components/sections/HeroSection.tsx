...
export const HeroSection: React.FC = () => {
  ...
  return (
    <section className="relative pt-24 pb-8 md:pt-40 md:pb-16 flex flex-col items-center text-center overflow-hidden">
      ...
      <div className="container relative z-10 mx-auto px-4 max-w-6xl">
        ...
        <div className="flex justify-center mb-6 animate-in fade-in slide-in-from-top-4 duration-1000 ease-out">
          <div className="inline-flex items-center gap-3 px-5 py-2 rounded-full glass border border-white/10 text-[10px] font-black uppercase tracking-[0.3em] text-foreground/90 shadow-xl">
        ...
        <div className="relative mb-6 group">
          <h1 className="text-5xl md:text-8xl lg:text-9xl font-black tracking-tighter leading-[0.82] animate-in fade-in slide-in-from-bottom-12 duration-1000 delay-100 ease-out">
            Synthesize <br />
        ...
        <p className="max-w-xl mx-auto text-base md:text-xl text-muted-foreground/80 mb-8 leading-relaxed font-medium animate-in fade-in slide-in-from-bottom-16 duration-1000 delay-200 ease-out">
          Engineer the future with production-ready AI agents. 
          Zero-latency orchestration for the modern billion-dollar enterprise.
        </p>
        
        {/* CTA Buttons */}
        <div className="flex flex-col sm:flex-row items-center justify-center gap-4 animate-in fade-in slide-in-from-bottom-20 duration-1000 delay-300 ease-out">
          <Button 
            size="lg" 
            onClick={handleGetStarted}
            className="bg-primary hover:bg-primary/90 text-[11px] h-14 px-10 rounded-2xl group font-black button-glow transition-all relative overflow-hidden"
          >
          ...
          <Button 
            ...
            className="glass text-[11px] h-14 px-10 rounded-2xl font-black border-white/10 hover:bg-white/10 transition-all group shadow-xl"
          >
            Request VIP Access
        ...
        <div className="mt-12 flex flex-wrap justify-center gap-8 items-center opacity-40 animate-in fade-in duration-1000 delay-500">
          <div className="flex items-center gap-2 group cursor-default">
            <ShieldCheck className="w-4 h-4 text-emerald-500 group-hover:scale-110 transition-transform" />
            <span className="text-[9px] font-black uppercase tracking-[0.3em]">SOC2 Certified</span>
          </div>
          <div className="h-px w-12 bg-foreground/10 hidden sm:block" />
          <div className="flex items-center gap-2">
            <span className="text-[9px] font-black uppercase tracking-[0.3em]">ISO/IEC 27001</span>
          </div>
          <div className="h-px w-12 bg-foreground/10 hidden sm:block" />
          <div className="flex items-center gap-2">
