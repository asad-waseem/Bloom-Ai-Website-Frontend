  ...
  return (
    <section className="relative pt-24 pb-12 md:pt-36 md:pb-20 flex flex-col items-center text-center">
      ...
      <div className="container relative z-10 mx-auto px-4">
        <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full glass border border-white/5 text-[10px] font-bold uppercase tracking-widest text-primary mb-8 animate-in fade-in slide-in-from-bottom-4 duration-700">
          <span className="flex h-1.5 w-1.5 rounded-full bg-primary animate-pulse" />
          Enterprise v2.0 is Live
          <ChevronRight className="w-3 h-3 ml-1 opacity-50" />
        </div>
        
        <h1 className="text-5xl md:text-7xl lg:text-8xl font-black mb-6 tracking-tighter leading-[0.95] animate-in fade-in slide-in-from-bottom-8 duration-700 delay-100">
          Intelligence <br />
          <span className="animate-gradient-text">By Design.</span>
        </h1>
        
        <p className="max-w-xl mx-auto text-sm md:text-lg text-muted-foreground/70 mb-10 leading-relaxed font-medium animate-in fade-in slide-in-from-bottom-12 duration-700 delay-200">
