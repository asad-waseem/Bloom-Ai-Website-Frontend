  ...
  return (
    <section className="relative pt-20 pb-12 md:pt-32 md:pb-24 flex flex-col items-center text-center overflow-hidden">
      ...
      <div className="container relative z-10 mx-auto px-4 max-w-6xl">
        {/* Status Badge */}
        <div className="flex justify-center mb-8 animate-in fade-in slide-in-from-top-4 duration-1000 ease-out">
        ...
        <p className="max-w-2xl mx-auto text-lg md:text-2xl text-muted-foreground/80 mb-10 leading-relaxed font-medium animate-in fade-in slide-in-from-bottom-16 duration-1000 delay-200 ease-out">
        ...
        <div className="mt-20 flex flex-wrap justify-center gap-10 items-center opacity-40 animate-in fade-in duration-1000 delay-500">
