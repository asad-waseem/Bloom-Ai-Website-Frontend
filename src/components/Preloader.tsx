      ...
      <div className="relative flex flex-col items-center gap-12">
        ...
        <div className="absolute bottom-12 flex flex-col items-center gap-2 opacity-30">
          <div className="flex items-center gap-3">
            ...
            <span className="text-[8px] font-black uppercase tracking-[0.3em]">Edge Compute Nodes Active</span>
          </div>
          <p className="text-[7px] font-black uppercase tracking-widest">Bloom AI Orchestrator v2.0.42</p>
        </div>
      </div>
    </div>
  )
