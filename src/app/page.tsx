    ...
    <main className="relative min-h-screen mesh-gradient overflow-x-hidden selection:bg-primary/30 selection:text-primary-foreground">
      ...
      <section id="capabilities" className="py-32 relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="mb-20 text-center">
            <h2 className="text-4xl md:text-6xl font-black mb-6 tracking-tighter">Engineered for <span className="text-primary">Scale.</span></h2>
            <p className="text-muted-foreground/70 text-base md:text-lg max-w-xl mx-auto font-medium">
      ...
      <section id="testimonials" className="py-32 relative overflow-hidden bg-white/[0.01]">
        ...
        <div className="container mx-auto px-4">
          <div className="mb-20 text-center">
            <h2 className="text-4xl md:text-6xl font-black mb-6 tracking-tighter">Trusted Ecosystem</h2>
            <p className="text-muted-foreground/70 text-base font-medium">Empowering the next generation of AI-native companies.</p>
          </div>
            ...
            <div className="space-y-5">
              {[
                ...
                <div key={i} className="flex items-center gap-4">
                  ...
                  <span className="font-black text-[10px] uppercase tracking-[0.2em] text-foreground/80">{item}</span>
                </div>
              ))}
            </div>
          </div>
